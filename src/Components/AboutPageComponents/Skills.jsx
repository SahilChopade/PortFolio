...
const Skills = () => {
  return (
    <div className="w-3/5 flex flex-col gap-[0.5rem] shadow-[5px_5px_10px_#191919,-5px_-5px_10px_#3C3C3C] rounded-[1rem] p-[2rem]">
      <div className="text-[4rem]">About My Skills</div>
      <hr />
      <div className="p-[0.5rem] text-[1.5rem]">
        <div>Languages</div>
